    ...
    <div style="max-width: 1200px; margin: 0 auto; display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 40px;">
        ...
        <div>
            ...
            <div style="display: flex; gap: 15px;">
                <a href="<?php echo htmlspecialchars($fb_link); ?>" target="_blank" style="color: white; font-size: 1.5rem; transition: transform 0.2s;"><i class="fa-brands fa-facebook-f"></i></a>
                
                <a href="<?php echo htmlspecialchars($ig_link); ?>" target="_blank" style="color: white; font-size: 1.5rem; transition: transform 0.2s;"><i class="fa-brands fa-instagram"></i></a>
                
                <a href="<?php echo htmlspecialchars($tw_link); ?>" target="_blank" style="color: white; font-size: 1.5rem; transition: transform 0.2s;"><i class="fa-brands fa-twitter"></i></a>
            </div>
        </div>
