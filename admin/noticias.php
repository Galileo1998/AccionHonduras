...
// 2. Obtener todas las noticias publicadas o en borrador
$query = "SELECT id, title, status, created_at, cover_image FROM news ORDER BY created_at DESC";
                    ...
                    <?php foreach ($noticias as $noticia): ?>
                        <tr>
                            ...
                            <td style="text-align: right;" class="action-links">
                                ...
                                <a href="noticias.php?delete=<?php echo $noticia['id']; ?>" class="delete" onclick="return confirm('¿Estás seguro de eliminar esta noticia?');" title="Eliminar"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
