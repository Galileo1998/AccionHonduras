...
// Matriz completa indexada de los 18 Departamentos y sus 298 Municipios
$division_politica = [
...
// Obtener todos los proyectos del socio
...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-content">
            ...
            <a href="socios.php" class="nav-link active"><i class="fa-solid fa-handshake" style="width:20px;"></i> Socios y Proyectos</a>
                                    ...
                                    <div class="muns-container" id="dept-box-<?php echo $departamento; ?>">
                                        <?php foreach ($municipios_lista as $muni): ?>
                                            <label class="checkbox-label" data-searchname="<?php echo strtolower($muni); ?>">
                                                <input type="checkbox" name="municipios[]" value="<?php echo $muni; ?>" onchange="updateCheckedCount(this)">
