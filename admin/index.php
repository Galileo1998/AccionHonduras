...
<head>
    ...
    <style>
        /* ... (Pega aquí el bloque de :root y estilos generales de tu builder anterior) ... */
        :root { --ah-primary: #34859B; --ah-accent: #46B094; --bg-canvas: #f8fafc; --text-main: #1e293b; --white: #ffffff; }
        body { font-family: 'Inter', sans-serif; display: flex; height: 100vh; background: var(--bg-canvas); margin: 0; }
        .sidebar { width: 280px; background: #0f172a; color: white; padding: 24px; }
        .main-wrapper { flex-grow: 1; padding: 40px; overflow-y: auto; }
        ...
        .btn-primary { background: linear-gradient(135deg, var(--ah-primary), var(--ah-accent)); color: white; padding: 10px 20px; text-decoration: none; border-radius: 8px; font-weight: 600; }
        ...
        .action-btn { background: #e2e8f0; color: var(--ah-primary); padding: 8px 12px; border-radius: 6px; text-decoration: none; font-size: 0.9rem; transition: 0.2s; margin-right: 5px; }
...
<aside class="sidebar">
    ...
    <div class="sidebar-content" style="padding: 24px; flex-grow: 1;">
        <div style="display: flex; flex-direction: column; gap: 15px;">
            <a href="index.php" style="color: white; text-decoration: none; display: flex; align-items: center; gap: 10px;">
                <i class="fa-solid fa-file-lines" style="width: 20px;"></i> Todas las Páginas
            </a>
            ...
            <a href="apariencia.php" style="color: #cbd5e1; text-decoration: none; display: flex; align-items: center; gap: 10px;">
                <i class="fa-solid fa-bars" style="width: 20px;"></i> Menú de Navegación
            </a>

            <a href="configuracion.php" style="color: #cbd5e1; text-decoration: none; display: flex; align-items: center; gap: 10px;">
                <i class="fa-solid fa-gears" style="width: 20px;"></i> Configuración Global
            </a>
        </div>
    </div>

    <div class="sidebar-footer" style="padding: 20px 24px; border-top: 1px solid rgba(255,255,255,0.1);">
        <a href="logout.php" style="color: #ef4444; text-decoration: none; display: flex; align-items: center; gap: 8px; font-size: 0.9rem;">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span style="background: #dcfce7; color: #166534; padding: 4px 8px; border-radius: 20px; font-size: 0.8rem;">Publicada</span></td>
                        <td>
                            <a href="builder.php?id=<?php echo $p['id']; ?>" class="action-btn"><i class="fa-solid fa-pen-ruler"></i> Editar Diseño (Bloques)</a>
