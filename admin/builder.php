...
if (is_numeric($page_id)) {
    $stmt = $db->prepare("SELECT title, slug, content_html FROM pages WHERE id = :id LIMIT 1");
...
<body>
    ...
    <div class="top-bar">
        ...
        <button class="btn btn-primary" onclick="saveP()" id="save-btn"><i class="fa-solid fa-save"></i> Guardar Código</button>
    </div>
    ...
    <script>
        ...
        // 1. DICCIONARIO DE BLOQUES (Plantillas Elementor-like)
        function addB(t) {
            const temps = {
        ...
        // 2. INYECCIÓN DEL MOTOR VISUAL EN EL IFRAME
        function upPrev() {
            if (isVisual) return;
    ...
    <body>
        ...
        <script>
            ...
            document.body.onclick = e => {
                ...
                // Mostrar controles contextuales
            ...
            // Sincronización maestra (Limpieza antes de enviar al editor)
            function sync() {
...
`;
        ...
        async function saveP() {
            ...
            setTimeout(() => { btn.innerHTML = '<i class="fa-solid fa-save"></i> Guardar Código'; btn.style.background = ''; }, 2000);
        }
